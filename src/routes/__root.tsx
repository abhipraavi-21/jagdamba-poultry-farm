...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Jagdamba Poultry Farms — Integrated Poultry Solutions" },
      { name: "description", content: "Jagdamba Poultry Farms delivers integrated poultry farming, feed, hatchery and processing solutions across India. Partner with us to grow." },
      { name: "author", content: "Jagdamba Poultry Farms" },
